...
//plus �xcentr�es le sont le moins possible, en calculant une valeur de 
//"centrage" correspondant � la "couronne de cases" la plus large sur laquelle
//se trouve des billes, et en cherchant � "�liminer" ces couronnes tour � tour.
//Le d�veloppement de cette IA a malheureusement �t� abandonn� face � quelques 
//inefficacit�s et complications (l�algo n�arrive m�me pas � se d�barrasser des 
//premi�res couronnes, et son principe est donc vite oubli�)
