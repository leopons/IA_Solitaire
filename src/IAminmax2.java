...
// Cette IA est un minmax classique, mais à chaque noeud de l'arbre des situations,
// l'algo ne viste qu'une partie des noeuds fils (contrairement au minmax classique qui les visite tous)
// et les noeuds visités sont ceux qui obtiennent le meilleur résultat avec le critère d'ordre 0

public class IAminmax2 extends IA {
